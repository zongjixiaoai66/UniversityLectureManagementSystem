...
//            xuanjianghuiCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<XuanjianghuiCollectionEntity> xuanjianghuiCollectionList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            XuanjianghuiCollectionEntity xuanjianghuiCollectionEntity = new XuanjianghuiCollectionEntity();
//                            xuanjianghuiCollectionEntity.setXuanjianghuiId(Integer.valueOf(data.get(0)));   //宣讲会 要改的
//                            xuanjianghuiCollectionEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            xuanjianghuiCollectionEntity.setXuanjianghuiCollectionTypes(Integer.valueOf(data.get(0)));   //类型 要改的
//                            xuanjianghuiCollectionEntity.setInsertTime(date);//时间
//                            xuanjianghuiCollectionEntity.setCreateTime(date);//时间
                            xuanjianghuiCollectionList.add(xuanjianghuiCollectionEntity);
                        ...
                        //查询是否重复
                        xuanjianghuiCollectionService.insertBatch(xuanjianghuiCollectionList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    ...
    public R add(@RequestBody XuanjianghuiCollectionEntity xuanjianghuiCollection, HttpServletRequest request){
        ...
        Wrapper<XuanjianghuiCollectionEntity> queryWrapper = new EntityWrapper<XuanjianghuiCollectionEntity>()
            ...
            .eq("yonghu_id", xuanjianghuiCollection.getYonghuId())
            .eq("xuanjianghui_collection_types", xuanjianghuiCollection.getXuanjianghuiCollectionTypes())
//            .notIn("xuanjianghui_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        XuanjianghuiCollectionEntity xuanjianghuiCollectionEntity = xuanjianghuiCollectionService.selectOne(queryWrapper);
        if(xuanjianghuiCollectionEntity==null){
