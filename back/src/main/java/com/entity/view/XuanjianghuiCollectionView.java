...
public class XuanjianghuiCollectionView extends XuanjianghuiCollectionEntity implements Serializable {
	...
	*/
	...
	private String xuanjianghuiCollectionValue;
	...
	* 获取： 类型的值
	*/
	public String getXuanjianghuiCollectionValue() {
		return xuanjianghuiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setXuanjianghuiCollectionValue(String xuanjianghuiCollectionValue) {
		this.xuanjianghuiCollectionValue = xuanjianghuiCollectionValue;
	}
	...
	public String toString() {
		return "XuanjianghuiCollectionView{" +
			", xuanjianghuiCollectionValue=" + xuanjianghuiCollectionValue +
