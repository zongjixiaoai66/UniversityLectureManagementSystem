...
var centerMenu = [
    ...
    ,{
        name: '宣讲会收藏',
        url: '../xuanjianghuiCollection/list.html'
    }
    ,{
        name: '宣讲会报名',
        url: '../xuanjianghuiYuyue/list.html'
    }
    ,{
        name: '就业信息',
        url: '../dangqianqingkuang/list2.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaoxuanjianghuiguanli/admin/dist/index.html#/login";
