<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="线下面试编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="线下面试编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="线下面试编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="线下面试编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="线下面试" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="线下面试" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="线下面试" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('线下面试不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="xianxia_types";
                        ruleForm["dicName"]="线下面试";
                        this.$http({
