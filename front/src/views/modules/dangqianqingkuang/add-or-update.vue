    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="就业状态" prop="dangqianqingkuangTypes">
                        <el-select v-model="ruleForm.dangqianqingkuangTypes" :disabled="ro.dangqianqingkuangTypes" placeholder="请选择就业状态">
                            <el-option
                                v-for="(item,index) in dangqianqingkuangTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="就业状态" prop="dangqianqingkuangValue">
                        <el-input v-model="ruleForm.dangqianqingkuangValue"
                            placeholder="就业状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="dangqianqingkuangText">
                        <el-input type="textarea"  :readonly="ro.dangqianqingkuangText" v-model="ruleForm.dangqianqingkuangText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.dangqianqingkuangText" label="备注" prop="dangqianqingkuangText">
                            <span v-html="ruleForm.dangqianqingkuangText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    dangqianqingkuangTypes: false,
                    dangqianqingkuangText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    dangqianqingkuangTypes: '',
                    dangqianqingkuangText: '',
                    insertTime: '',
                },
                dangqianqingkuangTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=dangqianqingkuang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.dangqianqingkuangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`dangqianqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.dangqianqingkuangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
