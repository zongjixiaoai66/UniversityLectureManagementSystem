<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui'">
                    <el-form-item class="select" v-if="type!='info'"  label="宣讲会" prop="xuanjianghuiId">
                        <el-select v-model="ruleForm.xuanjianghuiId" :disabled="ro.xuanjianghuiId" filterable placeholder="请选择宣讲会" @change="xuanjianghuiChange">
                            <el-option
                                    v-for="(item,index) in xuanjianghuiOptions"
                                    v-bind:key="item.id"
                                    :label="item.xuanjianghuiName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宣讲会标题" prop="xuanjianghuiName">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiName"
                                  placeholder="宣讲会标题" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12" v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xuanjianghuiPhoto" label="宣讲会封面" prop="xuanjianghuiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (xuanjianghuiForm.xuanjianghuiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="企业资质" prop="xuanjianghuiDaiyu">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiDaiyu"
                                  placeholder="企业资质" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宣讲会类型" prop="xuanjianghuiValue">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiValue"
                                  placeholder="宣讲会类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="专业" prop="zhuanyeValue">
                        <el-input v-model="xuanjianghuiForm.zhuanyeValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="招聘岗位" prop="xuanjianghuiGangwei">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiGangwei"
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="招聘人数" prop="xuanjianghuiRenshuNumber">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiRenshuNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宣讲时间" prop="xuanjianghuiTime">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiTime"
                                  placeholder="宣讲时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宣讲时间" prop="xuanjianghuiTime">
                            <el-input v-model="ruleForm.xuanjianghuiTime"
                                      placeholder="宣讲时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="线下面试" prop="xianxiaValue">
                        <el-input v-model="xuanjianghuiForm.xianxiaValue"
                                  placeholder="线下面试" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="审核状态" prop="xuanjianghuiYesnoValue">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiYesnoValue"
                                  placeholder="审核状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="审核状态" prop="xuanjianghuiYesnoValue">
                            <el-input v-model="ruleForm.xuanjianghuiYesnoValue"
                                      placeholder="审核状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xuanjianghui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="审核回复" prop="xuanjianghuiYesnoText">
                        <el-input v-model="xuanjianghuiForm.xuanjianghuiYesnoText"
                                  placeholder="审核回复" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="审核回复" prop="xuanjianghuiYesnoText">
                            <el-input v-model="ruleForm.xuanjianghuiYesnoText"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="xuanjianghuiYuyueUuidNumber">
                       <el-input v-model="ruleForm.xuanjianghuiYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.xuanjianghuiYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="xuanjianghuiYuyueUuidNumber">
                           <el-input v-model="ruleForm.xuanjianghuiYuyueUuidNumber"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    xuanjianghuiYuyueUuidNumber: false,
                    xuanjianghuiId: false,
                    yonghuId: false,
                    insertTime: false,
                },
                ruleForm: {
                    xuanjianghuiYuyueUuidNumber: new Date().getTime(),
                    xuanjianghuiId: '',
                    yonghuId: '',
                    insertTime: '',
                },
                ...
                yonghuOptions : [],
                rules: {
                   xuanjianghuiYuyueUuidNumber: [
                              { required: true, message: '报名编号不能为空', trigger: 'blur' },
                          ],
                   xuanjianghuiId: [
                              { required: true, message: '宣讲会不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `xuanjianghui/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.xuanjianghuiOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            xuanjianghuiChange(id){
                this.$http({
                    url: `xuanjianghui/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xuanjianghuiForm = data.data;
                    }
                });
            },
            yonghuChange(id){
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `xuanjianghuiYuyue/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.xuanjianghuiChange(data.data.xuanjianghuiId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xuanjianghuiYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xuanjianghuiYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
