    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校宣讲会管理系统注册</h1>
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="学院" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.xueyuanTypes" autocomplete="off" placeholder="学院"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="专业" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.zhuanyeTypes" autocomplete="off" placeholder="专业"  />
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/gaoxiaoxuanjianghuiguanli/img/back-img-bg.jpg);
